...
pub struct System {}
impl System {
    pub const COLLISION_MEMBERSHIP: u32 = 0b0000000000000010;
    /// Radius of a small system.
    pub const SMALL: f32 = 32.0;
    pub const MEDIUM: f32 = System::SMALL * 1.5;
    pub const LARGE: f32 = System::SMALL * 2.0;
}
...
impl Player {
    pub const COLLISION_MEMBERSHIP: u32 = 0b0000000000000001;
    pub const MIN_REALITY_BUBBLE_SIZE: f32 = 256.0;
}
